...
import { setJobResults, setTotalPagesCount, setAppliedJobs } from "@/actions/jobs";
...
export default function Jobs() {
    ...
    useEffect(() => {
        ...
        getJobs(account.accessToken, filters).then((jobs) => {
            ...
            dispatch(setTotalPagesCount(Math.ceil(jobs.meta.total / filters.resultsPerPage)))
        });
                ...
                <div className="pb-20">
                    ...
                    <div className="flex box-border">
                        <div className="jobs-column w-3/4">
                            {jobs.jobResults.map((job: any, index: number) => (
                            ...
                            {jobs.totalPagesCount > 1 &&
                                <div className="flex justify-center items-center mt-4">
                                    ...
                                    <div className="mx-4">{filters.queryPage}/{jobs.totalPagesCount}</div>
                        ...
                        <div className="applied-column w-1/4">
                            <div className="p-10 flex flex-col justify-center items-center text-2xl border border-black">
                                ...
                                {jobs.appliedJobs.map((job: any, index: number) => (
